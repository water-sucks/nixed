# This file was generated by nvfetcher, please do not modify it manually.
{
  ...
  "'plugin-diffview.nvim'" = {
    ...
    src = fetchFromGitHub {
      ...
      fetchSubmodules = false;
      sha256 = "sha256-T045YYbS+wU5kU7grj4vqOwMv491yyBWayPoAtqb3SA=";
    };
    date = "2023-01-27";
  };
  ...
  "'plugin-haskell-tools.nvim'" = {
    ...
    version = "5e1b41ef7338c0aa764425144378d8d1b3b59242";
    src = fetchFromGitHub {
      owner = "MrcJkb";
      repo = "haskell-tools.nvim";
      rev = "5e1b41ef7338c0aa764425144378d8d1b3b59242";
      fetchSubmodules = false;
      sha256 = "sha256-kaOXH7Em5L2DBFq9c0CW+hzCS1rkAymq6kg4Kbyb/Xg=";
    };
    date = "2023-01-29";
  };
  ...
  "'plugin-nvim-dap-ui'" = {
    ...
    version = "395382466f12325919708da238e90add967d0912";
    src = fetchFromGitHub {
      owner = "rcarriga";
      repo = "nvim-dap-ui";
      rev = "395382466f12325919708da238e90add967d0912";
      fetchSubmodules = false;
      sha256 = "sha256-1l3e7zAAVr6KdhXN8OYgCSYYmPa65iBcEK27UClC98o=";
    };
    date = "2023-01-29";
  };
  ...
  "'plugin-nvim-tree.lua'" = {
    ...
    version = "e14989c0eaa6f9c299d48f7e45ce1ed04b21180f";
    src = fetchFromGitHub {
      owner = "kyazdani42";
      repo = "nvim-tree.lua";
      rev = "e14989c0eaa6f9c299d48f7e45ce1ed04b21180f";
      fetchSubmodules = false;
      sha256 = "sha256-SD3ijI4xptHlfvMStq3+mKfiSqNZ2rGCuuRN5RhNnRM=";
    };
    date = "2023-01-28";
  };
  ...
  "'plugin-one-small-step-for-vimkind'" = {
    ...
    version = "fa14721ce80de5be132a099d98fe9a994432abf3";
    src = fetchFromGitHub {
      owner = "jbyuki";
      repo = "one-small-step-for-vimkind";
      rev = "fa14721ce80de5be132a099d98fe9a994432abf3";
      fetchSubmodules = false;
      sha256 = "sha256-GXfJebiYF1Phuod2emJs9RV32vE1gztdsu9W4Ok/Jx0=";
    };
    date = "2023-01-29";
  };
  "'plugin-playground'" = {
  ...
  "'plugin-vimtex'" = {
    pname = "'plugin-vimtex'";
    version = "13fa591e82f7fe0fedbb097e9869d32f6af207fe";
    src = fetchFromGitHub {
      owner = "lervag";
      repo = "vimtex";
      rev = "13fa591e82f7fe0fedbb097e9869d32f6af207fe";
      fetchSubmodules = false;
      sha256 = "sha256-VdFx1l9F2xKcHBt30rjF2GOmvsE5KB+N9/+pSMwxGxA=";
    };
    date = "2023-01-27";
  };
