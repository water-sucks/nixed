        ...
        keybind_presets = {
          neorg = function(keybinds)
            ...
            keybinds.map_event_to_mode("norg", {
              n = {
                { leader .. "tc", "core.norg.qol.todo_items.todo.task_cancelled", "Mark task canceled" },
                ...
                { leader .. "ti", "core.norg.qol.todo_items.todo.task_important", "Mark task important" },
                { leader .. "tp", "core.norg.qol.todo_items.todo.task_pending", "Mark task pending" },
                { leader .. "tr", "core.norg.qol.todo_items.todo.task_recurring", "Mark task recurring" },
